...
def process_input():
    ...
    for item in input_list:
        # extract the name and image URL from the input item
        if "[x] " in item and " !" in item:
            ...
            output_item = f"| {name[:27].ljust(30)} | :white_check_mark: |![]({image_url})|"
...
process_button = ttk.Button(root, text="Process", command=lambda: process_input(), style="Accent.TButton")
